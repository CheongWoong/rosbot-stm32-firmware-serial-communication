...
#define CLOCK_SOURCE                                                      USE_PLL_HSE_XTAL                                 // set by target:CORE2
#define LPTICKER_DELAY_TICKS                                              1                                                // set by target:FAMILY_STM32
#define MBED_ALL_STATS_ENABLED                                            0                                                // set by application[CORE2]
...
#define MBED_CONF_DRIVERS_UART_SERIAL_RXBUF_SIZE                          768                                              // set by application[CORE2]
#define MBED_CONF_DRIVERS_UART_SERIAL_TXBUF_SIZE                          768                                              // set by application[CORE2]
...
#define MBED_CONF_EVENTS_SHARED_DISPATCH_FROM_APPLICATION                 0                                                // set by application[CORE2]
#define MBED_CONF_EVENTS_SHARED_EVENTSIZE                                 1024                                             // set by application[CORE2]
...
#define MBED_CONF_EVENTS_SHARED_STACKSIZE                                 2048                                             // set by application[CORE2]
...
#define MBED_CONF_PLATFORM_DEFAULT_SERIAL_BAUD_RATE                       230400                                           // set by application[CORE2]
...
#define MBED_CONF_PLATFORM_STDIO_BAUD_RATE                                230400                                           // set by application[CORE2]
...
#define MBED_CONF_TARGET_LSE_AVAILABLE                                    0                                                // set by target:CORE2
...
#define ROSBOT_FW_VERSION                                                 "0.15.0"                                         // defined by application
#define UNITY_INCLUDE_CONFIG_H                                                                                             // defined by library:utest
#define WELLCOME_BANNER                                                                                                    // defined by application
#define _RTE_                                                                                                              // defined by library:rtos

// PlatformIO Library Dependency Finder (LDF)

// PlatformIO Library Dependency Finder (LDF)
#define DEBUG_LOGS_ENCODER 0

// PlatformIO Library Dependency Finder (LDF)
#define MPU9250
#define MPU9250_I2C_SDA SENS2_PIN4
#define MPU9250_I2C_SCL SENS2_PIN3
#define MPU9250_I2C_FREQUENCY 100000
#define MPU9250_I2C_RTOS_IMPL 1
#define MPU9250_NO_COMPASS_SUPPORT 1

// PlatformIO Library Dependency Finder (LDF)
#define USE_STM_DRV8848_DRIVER 1

// PlatformIO Library Dependency Finder (LDF)
#define ROSSERIAL_VERSION "1.1.0"
#define ROSSERIAL_TX RPI_SERIAL_TX
#define ROSSERIAL_RX RPI_SERIAL_RX
#define ROSSERIAL_BAUDRATE 525000
#define ROSSERIAL_INPUT_BUFFER_SIZE 512
#define ROSSERIAL_OUTPUT_BUFFER_SIZE 512
#define ROSSERIAL_RTOS_KERNEL_MS_TICK 1
